...
namespace GALAXY 
{
	...
	public:
        ...
        private:
            ...
            BPLayerInterfaceImpl	m_broadPhaseLayerInterface;									// The broadphase layer interface that maps object layers to broadphase layers
            ObjectVsBroadPhaseLayerFilterImpl m_objectVsBroadPhaseLayerFilter;					// Class that filters object vs broadphase layers
